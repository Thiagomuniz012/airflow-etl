...
def processar_e_inserir_stage_diario(caminho_arquivo, conn):
    """
    Função para processar o arquivo diário COTAHIST e inserir os dados na tabela de stage.

    Args:
    - caminho_arquivo (str): Caminho para o arquivo COTAHIST diário.
